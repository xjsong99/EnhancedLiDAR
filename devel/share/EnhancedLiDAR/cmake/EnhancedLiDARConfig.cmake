...
if(NOT "/home/song/EnhancedLiDAR/src/EnhancedLiDAR/include " STREQUAL " ")
  set(EnhancedLiDAR_INCLUDE_DIRS "")
  set(_include_dirs "/home/song/EnhancedLiDAR/src/EnhancedLiDAR/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'EnhancedLiDAR' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/song/EnhancedLiDAR/src/EnhancedLiDAR/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/song/EnhancedLiDAR/devel/lib;/home/song/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
