...
class OrganizeTool
{
  ...
  public:
    ...
    float ver_angle_res, hor_angle_res;//每隔多少度一个点
    int LINEPOINTQUANTITY;//每行有多少个点
    float lowestAngle; //最下方的ver_angle是多少度(正数)
    ...
    */
    ...
    void ground_remove(pcl::PointCloud<pcl::PointXYZI>::Ptr input_cloud_ptr,
                       pcl::PointCloud<pcl::PointXYZI>::Ptr ground_cloud_ptr,
                       pcl::PointCloud<pcl::PointXYZI>::Ptr object_cloud_ptr);
    void denser(pcl::PointCloud<pcl::PointXYZI>::Ptr organised_cloud_ptr,
                pcl::PointCloud<pcl::PointXYZI>::Ptr output_cloud_ptr);
    void denser_with_depth(pcl::PointCloud<pcl::PointXYZI>::Ptr input_cloud_ptr,
                           pcl::PointCloud<pcl::PointXYZI>::Ptr output_cloud_ptr,
                           double *depth_image);
